...
var MCP = `
MCP (Model Context Protocol) prompt configuration.

This content is licensed under the Apache License, Version 2.0.
Original source: https://github.com/cline/cline/blob/v3.3.0/src/core/prompts/system.ts
...
which you can then analyze to provide a comprehensive summary."`
